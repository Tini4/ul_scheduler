    ...
    <main class="px-1">
        ...
        <div v-if="add_enabled">
            <form>
                ...
                <div class="d-flex align-items-center gap-2 mt-2">
                    <input v-model="start_input" type="number" class="form-control" min="7" max="19" step="0.5" placeholder="Start" required>
                    <input v-model="length_input" type="number" class="form-control" min="1" max="13" step="0.5" placeholder="Length" required>
